<?php
return array(
    "Passwords do not match" => "两次密码必须填写，且要匹配",
    "Value is required and can't be empty" => '不能为空',
    "'%value%' contains characters which are non alphabetic and no digits" => "'%value%'只能包括字母或数字",
    ...
    "'%value%' is no valid email address in the basic format local-part@hostname" => "电子邮件地址格式错误",
    "'%hostname%' is not a valid hostname for email address '%value%'" => "电子邮件地址格式错误",
    "'%hostname%' does not appear to have a valid MX record for the email address '%value%'" => "电子邮件地址格式错误",
    "'%localPart%' not matched against dot-atom format" => "电子邮件地址格式错误",
    "'%localPart%' not matched against quoted-string format" => "电子邮件地址格式错误",
    "'%localPart%' is not a valid local part for email address '%value%'" => "电子邮件地址格式错误",
